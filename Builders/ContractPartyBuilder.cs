    ...
    public static class ContractPartyBuilder
    {
        ...
        private static void SetTables(WordDocument doc, Party p, string mode = "both")
        {
            ...
            if (mode == "both" || mode == "radio")
            {
                ...
                {
                    table = WordDocument.CreateTable(p.Талон_Маяк);
                    table2 = WordDocument.CreateTable(p.Талон_Маяк);
                ...
                {
                    table = WordDocument.CreateTable(p.Талон_Радио_России);
                    table2 = WordDocument.CreateTable(p.Талон_Радио_России);
                ...
                {
                    table = WordDocument.CreateTable(p.Талон_Вести_ФМ);
                    table2 = WordDocument.CreateTable(p.Талон_Вести_ФМ);
            ...
            if (mode == "both" || mode == "tele")
            {
                ...
                {
                    table = WordDocument.CreateTable(p.Талон_Россия_1);
                    table2 = WordDocument.CreateTable(p.Талон_Россия_1);
                ...
                {
                    table = WordDocument.CreateTable(p.Талон_Россия_24);
                    table2 = WordDocument.CreateTable(p.Талон_Россия_24);
